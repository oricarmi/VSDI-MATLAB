...
figure;
yyaxis left
plot(t,avgRes/params.experiment.N);ylabel('amp [au]');
yyaxis right
plot(t,params.experiment.responseSig)
ylabel('amp [au]');xlabel('time [sec]');title('Reponse to stimuli');
legend('Empirical Average Response','Theoretical Response');
